/// هذا الملف يحتوي على جميع النصوص الثابتة المستخدمة في التطبيق
/// يساعد في:
/// 1. إدارة النصوص من مكان مركزي
/// 2. تجنب التكرار
/// 3. تسهيل التعديلات والتحديثات
/// 4. دعم الترجمة متعددة اللغات لاحقاً
...
class TTexts {
  ...
  static const String orSignWith = "Or Sign With";
